...
[wookashwackomytest-polkahat-chai-matchers](https://www.npmjs.com/package/wookashwackomytest-polkahat-chai-matchers) adds Ethereum-specific capabilities to the [Chai](https://www.chaijs.com/) assertion library, making your smart contract tests easy to write and read.
...
Simply `require("wookashwackomytest-polkahat-chai-matchers")` in your Hardhat config and then the assertions will be available in your code.
...
const {
  anyValue,
} = require("wookashwackomytest-polkahat-chai-matchers/withArgs");
await expect(contract.call())
...
const {
  PANIC_CODES,
} = require("wookashwackomytest-polkahat-chai-matchers/panic");
