...
// import { isBigNumber, normalizeToBN } from "hardhat/common/bigInt";
...
//           const actualLength = normalizeToBN(actual[sizeOrLength]);
//           const expectedLength = normalizeToBN(value);
//           this.assert(
...
//         return;
//       }
//       const expected = normalizeToBN(expectedFlag[sizeOrLength]);
//       const actual = normalizeToBN(actualArg);
//       this.assert(
...
//         try {
//           const normalizedA = normalizeToBN(a);
//           const normalizedB = normalizeToBN(b);
...
//       const expected = normalizeToBN(expectedFlag);
//       const actual = normalizeToBN(actualArg);
//       this.assert(
//         compare(functionName, expected, actual),
...
//     ) {
//       const expected = normalizeToBN(expectedFlag);
//       const start = normalizeToBN(startArg);
//       const finish = normalizeToBN(finishArg);
//       this.assert(
...
//       const expected = normalizeToBN(expectedFlag);
//       const actual = normalizeToBN(actualArg);
//       const delta = normalizeToBN(deltaArg);
